...
class MolecularWeight {
  /// Map of elements to their atomic weights (atomic mass units)
  static final Map<String, double> _atomicWeights = {
    'H': 1.00794,
    'He': 4.002602,
    'Li': 6.941,
    'Be': 9.012182,
  ...
  /// ```
  ///
  /// Returns the molecular weight in atomic mass units (amu).
  /// Throws FormatException if formula contains unknown elements.
  ...
  /// Calculates molecular weight of a list of formulas.
  /// Returns a map of formula to molecular weight.
